    ...
    public partial class Printpreview : Form
    {
        ...
        private void Printpreview_Load( object sender , EventArgs e )
        {
            try
            {
                ...
                rpt.ReportClientDocument.LocaleID = CrystalDecisions.ReportAppServer.DataDefModel.CeLocale.ceLocaleHindi;
                rpt.ReportClientDocument.PreferredViewingLocaleID = CrystalDecisions.ReportAppServer.DataDefModel.CeLocale.ceLocaleHindi;
                rpt.ReportClientDocument.ProductLocaleID = CrystalDecisions.ReportAppServer.DataDefModel.CeLocale.ceLocaleHindi;
                ...
                rpt.SetParameterValue ( "_Item1Unit" , rep.Item1Unit );
                ...
                rpt.SetParameterValue ( "_Item2Unit" , rep.Item2Unit );
                ...
                rpt.SetParameterValue ( "_Item3Unit" , rep.Item3Unit );
                ...
                rpt.SetParameterValue ( "_Item4Unit" , rep.Item4Unit );
                ...
                rpt.SetParameterValue ( "_Item5Unit" , rep.Item5Unit );
                ...
                rpt.SetParameterValue ( "_Item6Unit" , rep.Item6Unit );
                ...
                rpt.SetParameterValue ( "_Item7Unit" , rep.Item7Unit );
                ...
                rpt.SetParameterValue ( "_Item8Unit" , rep.Item8Unit );
                ...
                rpt.SetParameterValue ( "_Item9Unit" , rep.Item9Unit );
                ...
                rpt.SetParameterValue ( "_Item10Unit" , rep.Item10Unit );
                ...
                rpt.SetParameterValue ( "_Item11Unit" , rep.Item11Unit );
            ...
            {
                MessageBox.Show ( "       Installation Corrupted. Print Failed.    " );
                this.Close ();
            }
        }
    }
